...
namespace optmed
{
    public partial class frmListTransportadoras : optmed.frmBaseList
    {
        ...
        protected override void carregaConsulta()
        {
            ...
            List<Cliente> ClienteList = clienteBLL.getCliente(p => p.cliente_tag.Any(c => c.tag == "Transportadora"), p => p.Id.ToString(), false, deslocamento, tamanhoPagina, out totalReg);
        ...
        protected override void ordenaCelula(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            switch (e.ColumnIndex)
            {
                ...
                case col_codigo_cliente:
                    {
                        ClienteList = clienteBLL.getCliente(p => p.cliente_tag.Any(c => c.tag == "Transportadora"),p => p.codigo_cliente_integracao, direction != ListSortDirection.Ascending, deslocamento, tamanhoPagina, out totalReg);
                    }
                    break;

                case col_razao_social:
                    {
                        ClienteList = clienteBLL.getCliente(p => p.cliente_tag.Any(c => c.tag == "Transportadora"),p => p.razao_social, direction != ListSortDirection.Ascending, deslocamento, tamanhoPagina, out totalReg);
                    }
                    break;

                case col_nome_fantasia:
                    {
                        ClienteList = clienteBLL.getCliente(p => p.cliente_tag.Any(c => c.tag == "Transportadora"), p => p.nome_fantasia, direction != ListSortDirection.Ascending, deslocamento, tamanhoPagina, out totalReg);
                    }
                    break;

                case col_cnpj_cpf:
                    {
                        ClienteList = clienteBLL.getCliente(p => p.cliente_tag.Any(c => c.tag == "Transportadora"), p => p.cnpj_cpf, direction != ListSortDirection.Ascending, deslocamento, tamanhoPagina, out totalReg);
                    }
                    break;

                case col_contato:
                    {
                        ClienteList = clienteBLL.getCliente(p => p.cliente_tag.Any(c => c.tag == "Transportadora"), p => p.logradouro, direction != ListSortDirection.Ascending, deslocamento, tamanhoPagina, out totalReg);
                    }
                    break;

                case col_endereco:
                    {
                        ClienteList = clienteBLL.getCliente(p => p.cliente_tag.Any(c => c.tag == "Transportadora"), p => p.endereco, direction != ListSortDirection.Ascending, deslocamento, tamanhoPagina, out totalReg);
                    }
                    break;

                case col_estado:
                    {
                        ClienteList = clienteBLL.getCliente(p => p.cliente_tag.Any(c => c.tag == "Transportadora"), p => p.estado, direction != ListSortDirection.Ascending, deslocamento, tamanhoPagina, out totalReg);
                    }
                    break;

                case col_cidade:
                    {
                        ClienteList = clienteBLL.getCliente(p => p.cliente_tag.Any(c => c.tag == "Transportadora"), p => p.cidade, direction != ListSortDirection.Ascending, deslocamento, tamanhoPagina, out totalReg);
                    }
                    break;

                case col_cep:
                    {
                        ClienteList = clienteBLL.getCliente(p => p.cliente_tag.Any(c => c.tag == "Transportadora"), p => p.cep, direction != ListSortDirection.Ascending, deslocamento, tamanhoPagina, out totalReg);
                    }
                    break;

                case col_email:
                    {
                        ClienteList = clienteBLL.getCliente(p => p.cliente_tag.Any(c => c.tag == "Transportadora"), p => p.email, direction != ListSortDirection.Ascending, deslocamento, tamanhoPagina, out totalReg);
                    }
                    break;
                ...
                default:
                    {
                        ClienteList = clienteBLL.getCliente(p => p.cliente_tag.Any(c => c.tag == "Transportadora"), p => p.Id.ToString(), direction != ListSortDirection.Ascending, deslocamento, tamanhoPagina, out totalReg);
                    }
                    break;
            }
        ...
        protected override void executeCellEndEditChild(object sender, DataGridViewCellEventArgs e)
        {
            ...
            predicate = predicate.And(p => p.cliente_tag.Any(c => c.tag == "Transportadora"));
